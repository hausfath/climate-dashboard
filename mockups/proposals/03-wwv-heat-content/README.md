...
|---|---|---|---|---|---|---|
| Warm Water Volume index (T > 20 °C volume, 5°N–5°S, 120°E–80°W) | NOAA/PMEL, GTMBA Project Office | `https://www.pmel.noaa.gov/tao/wwv/data/wwv.dat` (documentation: `https://www.pmel.noaa.gov/tao/wwv/`) | 1980-01 → 2026-06 at retrieval | Monthly (published in arrears) | US-Gov work; no explicit licence stated (public domain) | **Derived from ocean analyses** (gridded subsurface temperature analyses; not a direct observation) |
...
5. Update cadence: WWV posts in arrears (Jun 2026 was latest at retrieval) —
